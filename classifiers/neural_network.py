...
class SoftmaxNetwork:
    ...
    def __init__(self, training_data, test_data, training_labels, test_labels=None):
        ...
        self.training_labels = self._prepare_data_labels(training_labels)
        self.test_labels = self._prepare_data_labels(test_labels)
    ...
    def test(self):
        ...
        return (self.session.run(accuracy, feed_dict={self.x: self.test_data,
                                                      self.y_: self.test_labels}))

    def _prepare_data_labels(self, training_labels):
